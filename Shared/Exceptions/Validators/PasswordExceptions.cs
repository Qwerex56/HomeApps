...
public sealed class PasswordIsNullException : ValidationException {
    public override string ErrorCode => "Password is null.";

    public PasswordIsNullException() : base("Password is null.") { }
    public PasswordIsNullException(string? message) : base("Password is null.") { }
    public PasswordIsNullException(string? message, Exception inner) : base("Password is null.", inner) { }
}